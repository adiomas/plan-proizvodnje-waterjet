...
export function StatusBar({ scheduled, machines }: StatusBarProps) {
  ...
  return (
    <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-4 py-2 sm:py-2.5 bg-white border-t text-[11px] sm:text-xs flex-shrink-0 overflow-x-auto lg:pb-safe">
      {machines.map((m) => (
